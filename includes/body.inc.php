...
?>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="index.php">Cães & Gatos</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="caes.php">Cães</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image: url('imgs/slide1.jpg')">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>Momento de ternura</h3>
                            <p>Cães e gatos podem ser amigos.</p>
                        </div>
                    </div>
    ...
    function bottom(){
        ...
        <footer class="py-5 bg-dark">
            <div class="container">
                <p class="m-0 text-center text-white">Copyright &copy; Leandro Pereira 2021</p>
            </div>
            <!-- /.container -->
        </footer>
